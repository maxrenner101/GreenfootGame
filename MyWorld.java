...
public class MyWorld extends World
{
    ...
    {    
        ...
        showText("Use arrows to move the penguin Tux.\nCatch seven fish or 50 balloons to win.\nTouching a bomb ends the game.\nPress 🚩 Run to start then s.", textX, textY1);
    }
    ...
    private void updateText() {
        showText("Blue Balloons Popped: " + balloonsPopped + "\n\nFishes Caught: " + fishCaught, WIDTH/2, 3*HEIGHT/4);
    }
